...
while True:
    ...
    if marker_corners:
        ...
        for ids, corners, i in zip(marker_IDs, marker_corners, total_markers):
            if 13 in ids:
                ...
                print("Desired Yaw:", desired_yaw)  #yaw in terms of rads
    ...
    # This calculation depends on how you're determining the desired_yaw
                   ...
                   if desired_yaw > 0:  # If desired_yaw is positive, move left
                      velocity_y = -1.0
                   elif desired_yaw < 0:  # If desired_yaw is negative, move right
                      velocity_y = 1.0
